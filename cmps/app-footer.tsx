...
export function AppFooter({ toggleModal }: Props) {
    return (
        <footer>
            ...
            <div className="relative top-16 h-[500px]">
                ...
                <div className="relative text-right pr-4 pt-32">
                    ...
                    <button onClick={toggleModal}
                        className="w-max rounded-3xl bg-[#ffd935] text-sm duration-300 transition-all mt-4 px-8 py-3 hover:bg-[#dab200]">אני מעוניין</button>
                </div>
            </div>
        </footer>
    )
